...
Connection.create(name: "Temperature Sensor", catagory: :gpio, setup: 'ds18b20', run: 'ds18b20', io_type: :input, icon: 'temp_sensor_digital')
...
Connection.create(name: "Relay", catagory: :gpio, io_type: :output, setup: 'relay', run: 'relay', icon: 'relay')
